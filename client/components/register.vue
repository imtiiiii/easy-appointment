  ...
  <div>
    ...
    <div class="_log_form_main" style="margin-top: 150px">
      ...
      <div class="_log_form">
        ...
        <!-- **********STUDENT ID ************ -->
        <div class="_log_input_group" v-if="form.user_type === 'student'">
          <Input
...
export default {
  ...
  methods: {
    async register() {
      ...
      if (
        (this.form.user_type === "student" && this.form.student_id === null) ||
      ...
      if (this.form.user_type === "teacher") this.form.student_id = null;
